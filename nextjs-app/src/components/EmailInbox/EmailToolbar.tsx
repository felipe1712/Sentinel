...
const image2 = "/images/users/avatar-2.jpg";
const image3 = "/images/users/avatar-3.jpg";
const image4 = "/images/users/avatar-4.jpg";
const image5 = "/images/users/avatar-5.jpg";
...
const EmailToolbar = () => {
  ...
  const selectmailProperties = createSelector(selectLayoutState, mail => ({
    mailDetails: mail.mailDetails,
    isLoader: mail.isLoader,
  }));
  // Inside your component
  const { mailDetails, isLoader } = useSelector(selectmailProperties);
          ...
          <div className="border-bottom border-bottom-dashed">
            <Row className="mt-n2 mb-3 mb-sm-0">
              <Col className="col-sm-auto order-1 d-block d-lg-none">
                <button
                  type="button"
                  className="btn btn-soft-success btn-icon btn-sm fs-16 email-menu-btn material-shadow-none"
                >
                ...
                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                  ...
                  <UncontrolledDropdown>
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                      <DropdownItem onClick={() => labeledEmail("support")}>
                        Support
                      </DropdownItem>
                      <DropdownItem onClick={() => labeledEmail("freelance")}>
                        Freelance
                      </DropdownItem>
                      <DropdownItem onClick={() => labeledEmail("social")}>
                        Social
                      </DropdownItem>
                      <DropdownItem onClick={() => labeledEmail("friends")}>
                        Friends
                      </DropdownItem>
                      <DropdownItem onClick={() => labeledEmail("family")}>
                        Family
                      </DropdownItem>
                    </DropdownMenu>
                  </UncontrolledDropdown>
                  ...
                  <UncontrolledDropdown>
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                      <DropdownItem onClick={() => readAll("read")}>
                        Mark all as Read
                      </DropdownItem>
                    </DropdownMenu>
                  </UncontrolledDropdown>
              ...
              <ul className="message-list" id="mail-list">
                {filteredMails.length === 0 ? (
                  ...
                  filteredMails.map((item: any, key: any) => (
                    <li
                      className={classnames({ unread: item.unread })}
                      key={key}
                      id={item.forId}
                    >
                      ...
                      >
                        <Link href="#" className="subject">
                          {" "}
                          {item.badge ? (
                            <span className="me-2 ">{item.badge}</span>
                          ) : null}{" "}
                          {item.subject} -{" "}
                          <span className="teaser">{item.teaser}</span>
                        </Link>
                  ...
                  <button
                    ...
                    className={
                      emailinfo.category === "starred"
                        ? "btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn material-shadow-none active"
                        : "btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn material-shadow-none"
                    }
                  ...
                  <Row>
                    <Col>
                      <ButtonGroup>
                        <Button
                          size="sm"
                          color="light"
                          className="py-0 fs-15 material-shadow-none"
                          id="Bold1"
                        >
                    ...
                    <Col className="col-auto">
                      <UncontrolledButtonDropdown>
                        ...
                        <DropdownMenu>
                          <DropdownItem>
                            <i className="ri-timer-line text-muted me-1 align-bottom" />{" "}
                            Schedule Send
                          </DropdownItem>
                        </DropdownMenu>
                      </UncontrolledButtonDropdown>
              ...
              >
                ...
                >
                  {(messages || [])?.map((item: any, key: number) => (
                    <li
                      className={
                        item.isSender ? "chat-list left" : "chat-list right"
                      }
                      key={key}
                    >
                          ...
                          <div className="ctext-wrap">
                            ...
                            <UncontrolledDropdown className="align-self-start message-box-drop">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownItem
                                  onClick={(e: any) => copyMessage(e.target)}
                                >
                                  <i className="ri-file-copy-line me-2 text-muted align-bottom"></i>
                                  Copy
                                </DropdownItem>
                                <DropdownItem onClick={() => deleteChat(item)}>
