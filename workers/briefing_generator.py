...
2. CINCO PUNTOS CLAVE (ordenados por importancia política):
   Cada punto: titular + 2 líneas de contexto + nivel de atención requerida
...
REGLAS:
- Tono: memo ejecutivo para político de alto nivel
- Evitar jerga técnica, siglas sin explicar y datos sin contexto
- Siempre incluir implicación política de cada hecho
- Nunca usar lenguaje policial o de reporte técnico
...
async def fn_generate_briefing():
    ...
    briefing_payload = {
        ...
        "watch_today": [
            "Sesión del Congreso del Estado de Querétaro a las 10:00 hrs",
    ...
    logger.info("Briefing Matutino para Querétaro generado exitosamente.")
